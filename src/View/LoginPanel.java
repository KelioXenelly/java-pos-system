...
public class LoginPanel extends javax.swing.JFrame {
    ...
    private void handleLogin() {
        ...
        Users loggedInUser = usersDAO.login(username, password);

        if(loggedInUser != null) {
            JOptionPane.showMessageDialog(this, "Login Berhasil!\nSelamat datang, " + loggedInUser.getUsername());

            String role = loggedInUser.getRoles().getRolesName();
    ...
    private void openAdminPanel() {
        View.Admin.Dashboard dashboard = new View.Admin.Dashboard();
        dashboard.setVisible(true);
        this.setVisible(false);
    }
    
    private void openCashierPanel() {
        View.Kasir.Dashboard dashboard = new View.Kasir.Dashboard();
        dashboard.setVisible(true);
        this.setVisible(false);
    }
